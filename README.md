## Mercado de Trabalho e Economia Popular no Brasil
...
#
```{r}
setwd("C:/Users/u345129/OneDrive - IBERDROLA S.A/R_Projetos/3.PNAD")
```
#
...
pnadc <- read_pnadc("PNADC_042025.txt", "input_PNADC_trimestral.txt")
pnadc <- pnadc_labeller(pnadc, "dicionario_PNADC_microdados_trimestral.xls")
...
pnadc <- pnadc[, ..variaveis_selecionadas]

# 4. Criar variáveis derivadas
pnadc[, VD4009 := as.character(VD4009)]
pnadc[, Conta_propria := factor(
...
pnadc[, V4010 := as.character(V4010)]
...
setnames(pnadc, "Descricao", "V4010_descricao")
